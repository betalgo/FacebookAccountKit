...
using FacebookAccountKit.AccountKitResponseModels;
...
{ /// <summary>
  ...
  /// !Remember to call the "GetTokenAsync" method after creating the new instance.This part will be designed more smoothly.
  /// </summary>
    public class FacebookAccountKitSdk
    {
        ...
        /// </summary>
        /// <returns></returns>
        /// <exception cref="Error">If a facebook error occurs during request, this method throws an error</exception>
        ...
        /// If an error occurs while attempting to access user information, the method returns false. So, method's false-value return does not guarantee user-generated error.
        /// </summary>
        /// <param name="phoneNumber">User</param>
        /// <returns></returns>
